...
async function buildCommand() {
    console.log(chalk_1.default.cyan.bold('🌀 Build du projet Vortex...\n'));
    ...
    // Build Next.js
    const buildSpinner = (0, ora_1.default)('Build Next.js...').start();
    const nextBuild = (0, child_process_1.spawn)('npx', ['next', 'build'], {
        stdio: 'inherit',
        shell: true,
    });
